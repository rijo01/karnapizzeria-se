      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {featured.map((item, i) => (
            <article
              key={item.number}
              className="relative p-8 rounded-2xl bg-gradient-to-br from-[var(--color-ink-50)] to-[var(--color-ink)] border border-white/5 card-glow group transition-all duration-500 hover:-translate-y-1"
            ...
            >
              ...
              <h3 className="font-display text-3xl text-[var(--color-cream)] mb-3">
                {item.name}
              </h3>
